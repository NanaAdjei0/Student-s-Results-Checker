...
CREATE TABLE `tblresult` (
  `Id` int(10) NOT NULL AUTO_INCREMENT PRIMARY KEY, -- Set as auto-increment and primary key
  ...
  `hw3` int(10) NOT NULL,
  `hw4` int(10) NOT NULL,
  `clt1` int(10) NOT NULL,
  `clt2` int(10) NOT NULL, -- Corrected to `clt1`
  `midTerm` int(10) NOT NULL,
  `endTerm` int(10) NOT NULL  
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
INSERT INTO `tblresult` (`Id`, `fullName`, `matricNo`,  `departmentId` , `levelId`, `facultyId`, `semesterId`, `sessionId`, `courseCode`, `courseUnit`, `exx1`, `exx2`, `exx3`, `exx4`, `hw1`, `hw2`, `hw3`, `hw4`, `clt1`, `clt2`, `midTerm`, `endTerm`) VALUES
(19, 'Hands Kwaku',  'q123', '1' , '1', 1, '2', '1', 'P225', '5', '1', '2', '3', '4', '1', '2', '3', '4', '10', '20', '20', '79');
