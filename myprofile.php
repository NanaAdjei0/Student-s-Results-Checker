    ...
    <!-- <div class="date">
      ...
      <!-- DATE(CALENDER) -->
            ...
            <div class="recent-orders">
                ...
                <div class="profile">
                <a href="#"  >
                 <img id="img">  <span style="font-size: 50px;" class="material-icons-sharp pro-size">account_circle</span>
                    

                </a>
                <h3>Hello &nbsp; <?php     echo  $firstname;?> &nbsp; <?php     echo  $ $lastname;?> &nbsp; <?php     echo  $othername;?> </h3>
                <h3>Staff Id:  &nbsp; <?php     echo  $staffId;?></h3>
                <h3>Email Address:  &nbsp; <?php     echo $emailAddress;?></h3>
              
               

                <!-- <input class="profile" id="input" type="file"> -->
        ...
        <div class="right">
            <div class="top">
                ...
                <div class="profile">
                    <div class="info">
                        <p>Hello <b><?php     echo  $firstname;?></b></p>
                        <!-- <small class="text-muted">Admin</small> -->
                    </div>
                    <div class="profile-photo1">
                    <span style="font-size: 50px;" class="material-icons-sharp pro-size">account_circle</span>
                    </div>
                </div>
            </div>
            ...
            <div class="recent-updates">
                ...
                <!-- <h2> <span  style="left: 300px;" class="material-icons-sharp">addition</span>New Subject</h2> -->
                   ...
                   <!-- <button class="gradient-button"><a href="createCourses.php"><h3>Add New Subject</h3></a> </button> -->
                   <style>
...
<footer >Copyright &copy;Almighty Vision Academy SBA || Powered by WillOrg</footer> <br>
